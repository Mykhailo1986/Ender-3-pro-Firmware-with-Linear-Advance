...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  25.37,  25.37 }
    #define DEFAULT_Ki_LIST {   2.23,   2.23 }
    #define DEFAULT_Kd_LIST { 72.05, 72.05 }
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 195.38
  #define DEFAULT_bedKi 35.86
  #define DEFAULT_bedKd 709.68

  // FIND YOUR OWN: "" to run autotune on the bed at 90 degreesC for 8 cycles.
#endif // PIDTEMPBED
